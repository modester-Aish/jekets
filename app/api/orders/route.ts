...
export async function POST(request: NextRequest) {
  try {
    ...
    const { productId, quantity, size, customer } = body
    ...
    const orderData = {
      payment_method: 'bacs', // Bank transfer (you can change this)
      payment_method_title: 'Direct Bank Transfer',
      set_paid: false, // Set to true if payment is already received
      billing: {
